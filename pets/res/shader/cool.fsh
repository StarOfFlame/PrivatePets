...
void main(void){
    ...
    float th = sin(time*0.1)*sin(time*0.13)*3.;
    ...
    vec3 objCol = vec3(f*0.5, f*0.3, 0.);
    col = (objCol * (diff + 0.5) + vec3(0.5, 0.3, 0.)*spec) * atten;
